...
| **3-Second Debounce (Batching)** | Transactions of the same type for a player are batched together until a 3-second inactivity cooldown (debounce) passes. *Example:* Tapping +10 three times within 3 seconds results in a single "+$30" entry in the log once the timer expires. |
...
* **Log Format:** `[Turn/Phase] - [Player Name] - [Action Type] - [Amount]`
    * *Example:* `Dinner Time - Player Red: +$40`
    * *Example:* `Payday - Player Blue: -$15`
